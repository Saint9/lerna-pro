function load(script: HTMLElement, resolve, reject?: any) {
...
function ieLoad(script: HTMLElement, resolve: { (value: unknown): void; (arg0: string): void; }) {
...
export const loadjs = (path: string) => {
