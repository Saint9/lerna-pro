  ...
  <div class="vux-week-calendar">
    ...
    >
      <template v-for="(item, index) in [lastWeekList, currentWeekList, nextWeekList]">
        <swiper-item :key="index" :data-start="item[0].format" :id="`x000${index}`">
              ...
              <div class="vux-week-calendar-each-day-box">
                ...
                >
                  <span class="vux-week-calendar-each-day" :style="getMarkStyle(i)">
                    {{ i.str }}
                    <span
                      class="vux-week-calendar-top-tip"
                      v-if="isShowTopTip(i)"
                      :style="isShowTopTip(i, 'style')"
                    >
...
export default {
  ...
  methods: {
    ...
    onIndexChange (newIndex) {
      const el = document.querySelector('#x000' + newIndex)
